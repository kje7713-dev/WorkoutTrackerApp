...
public struct Media: Codable, Equatable {
    /// Video URLs for media content (normalized to array)
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.commonFaults = (try? container.decode([String].self, forKey: .commonFaults)) ?? []
        self.keyCues = (try? container.decode([String].self, forKey: .keyCues)) ?? []
        self.checkpoints = (try? container.decode([String].self, forKey: .checkpoints)) ?? []
    }
