    ...
    private var featuresSection: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            FeatureRowContent(
                ...
                subtitle: "Import and parse workout plans from JSON files generated by ChatGPT, Claude, or any AI assistant"
            )
            
            FeatureRowContent(
                icon: "sparkles",
                title: "JSON Workout Import",
                subtitle: "Paste or upload JSON workout plans directly into the app"
            )
            
            FeatureRowContent(
                icon: "list.bullet.clipboard",
                title: "AI Prompt Templates",
                subtitle: "Copy-paste ready prompts for generating structured workout blocks"
            )
            
            FeatureRowContent(
                icon: "square.and.arrow.down",
                title: "Block Library Management",
                subtitle: "Save and organize AI-generated training blocks"
            )
        }
    }
